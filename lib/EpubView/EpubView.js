...
var EpubView = function (_Component) {
  ...
  function EpubView(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EpubView).call(this, props));
  ...
  _createClass(EpubView, [{
    ...
    value: function componentDidMount() {
      ...
      var url = _props.url;
      var tocChanged = _props.tocChanged;

      this.book = new _epubjs2.default(url);
    ...
    value: function initReader() {
      ...
      var locationChanged = _props2.locationChanged;
    ...
    value: function render() {
      ...
      var loadingView = _props3.loadingView;
